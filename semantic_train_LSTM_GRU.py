...
class TrainANN():  
    ...
    def embedding(self,max_words = 10000,full_query = True,maxlen = 250,glove_dir = '/Users/irene/Downloads/glove.6B'):
        ...
        :return:
        """
        print('pre-trained GloVe representation download needed https://github.com/stanfordnlp/GloVe')
        # Concat columns
        if full_query:
...
if __name__ == '__main__':
    ...
    df.embedding(max_words = 10000,full_query = False,maxlen = 500,glove_dir = '/Users/irene/Downloads/glove.6B')
    df.LSTM(max_words = 10000,maxlen = 500,shuffle=False)
    df.GRU(max_words = 10000,maxlen = 500,shuffle = False)
