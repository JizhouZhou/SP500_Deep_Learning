...
class TrainANN():  
    ...
    def make_models(self):
        ...
        test_FN = (confusion_matrix(y_test, yp_test))[1][0]
        sens = test_TP/(test_TP + test_FN)
        test_TN = (confusion_matrix(y_test, yp_test))[0][0]
        ...
        print('The sensitivity of the model on the testing set is {}%.'.format(round(sens*100, 2)))
        print('The specificity of the model on the testing set is {}%.'.format(round(spec*100, 2)))
